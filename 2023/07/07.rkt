...
(define (hand-to-type-num sorted-by-count) ; return val: bigger number is more winningest
  ...
  (match sorted-by-count
    ...
    [(list (list _ 3) (list _ 2) _ ...)  4] ; full house
    [(list (list _ 3)            _ ...)  3] ; 3 of a kind
    [(list (list _ 2) (list _ 2) _ ...)  2] ; 2 pair
    [(list (list _ 2)            _ ...)  1] ; 1 pair
    [ _                                  0] ; ruh roh
    ))
...
(let* [[split-input (string-split input-large)]
  ...
  #| (pretty-print (r-fold-with-index-decrementing
                  ...
                  0)) |#
  ; looking for 5905...
  ; full input::: 253997357 is too high
  ;               253552043 too high...
  )
(printf "\ndone\n")
